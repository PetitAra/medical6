...
public class ListePatients extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Patient> pl= pliste.getPatients();
		} catch (Exception e1) {
...
//				out.println("<tr>");
//				out.println("<td>1</td><td>"+p.getNom() + " "+p.getPrenom()+"</td><td>"+p.getLocalDatenaissance()
//				+"</td><td>"+p.getAdresse()+"</td><td>"+p.getVille()+"</td><td>"+p.getPays()+"</td>");
//				out.println("</tr>");
//			}
//			
//		} catch (Exception e) {
